...
> 2026-08-27 기준 0026–0030은 운영에 적용 완료됐다. 저장소 journal에 0031이
> 추가된 뒤 이 문서의 runner는 더 새로운 migration을 함께 적용하지 않도록
> 의도적으로 실행을 거부한다. 다음 변경은
> [0031 collector registry 가이드](./2026-08-27-agent-telemetry-collector-migration.md)를 따른다.
