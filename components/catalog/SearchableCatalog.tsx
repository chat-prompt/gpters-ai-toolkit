...
import { CatalogItemSummary, TAGS, DIFFICULTY_LABELS, ItemType, Difficulty, TeamTag, TEAM_TAGS } from '@/lib/core/types'
import { TeamTagBadge } from '../social/TeamTagSelector'
import { SearchAutocomplete } from './SearchAutocomplete'
import { naturalLanguageSearch, extractKeywords, getDidYouMeanSuggestions } from '@/lib/search/search-utils'
