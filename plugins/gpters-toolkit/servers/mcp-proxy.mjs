 ...
 * - MCP_URL: The MCP server URL (default: https://company-ai-toolkit.vercel.app/api/mcp)
 * - MCP_TOKEN: Bearer token for authentication (required)
 *
 * Usage:
 * This script is bundled with the gpters-toolkit plugin and automatically
 * configured when the plugin is installed.
 */
