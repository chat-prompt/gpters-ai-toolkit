      ...
      <main className="relative z-10 max-w-5xl mx-auto px-8 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[10px] font-semibold tracking-[0.2em] text-[var(--accent-cyan)] uppercase">
              Skill
            </span>
            {item.difficulty && (
        ...
        <div className="glass rounded-2xl p-8 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-medium text-[var(--text-primary)]">skill.md</h2>
            </div>
