...
describe('MCP Handlers', () => {
  ...
  describe('executeTool', () => {
    ...
    it('should inject outcome hint into get_plugin_content response', async () => {
      ...
      expect(parsed.content).toContain('report_skill_execution_started')
      expect(parsed.content).toContain('report_skill_execution')
      expect(parsed.content).toContain('attemptId')
      expect(parsed.content).toContain('report_skill_outcome')
      expect(parsed.content).toContain('skillId="test-skill"')
      expect(parsed.content).toContain('applied=false')
