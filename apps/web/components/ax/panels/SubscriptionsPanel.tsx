 ...
 *
 * 구독 데이터의 정본은 「지니파이(주) 결제 내역」 `구독 로스터` 탭이고, 이 표는 사본이다.
 * 갱신 담당과 주기가 **최하영 · 월 1회**로 확정돼서(DEV-4319, 2026-09-06) 기준을 그 주기에 맞춘다.
 * 14일이던 값은 월 1회 갱신에서 매달 후반 내내 경고가 켜져 있어, 경고가 신호 구실을 못 했다.
 * 31일이면 "이번 달 갱신이 빠졌다"일 때만 켜진다.
 */
