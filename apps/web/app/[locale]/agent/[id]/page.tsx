 ...
 * content, installation guide, dependencies, and related items.
 */
 ...
 */
export default async function AgentPage({ params }: { params: Promise<{ locale: string; id: string }> }) {
  ...
  tocItems.push({ id: 'content', label: 'agent.md' })
